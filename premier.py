		...
		if len(i)<3:
			...
			if len(i)==3 or len(i)==4 or len(i)==5:
				...
				if "id" in ct:
					...
					results.append("moonton")
					results.append("cantik")
					results.append("ganteng")
					results.append("freefire")
					results.append("garena")
					results.append("garentod")
					results.append("doraemon")
					results.append("anjing")
					results.append("123456")
					results.append("name123")
					results.append("name12345")
					...
					results.append("100200")
					results.append("111222")
				elif "pk" in ct:
					results.append("pakistan")
					results.append("hindia")
					results.append("111222")
					results.append("112233")
					results.append("123456")
					results.append("100200")
